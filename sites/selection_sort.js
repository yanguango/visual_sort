...
aG="black",S=254,B=255,aB=250,D=1073741823,C=200,q=400,aF=390,j="",aD="canvas",R=" : file already exists",aA="gray",Q="/",aE="fd ",aC="index out of bounds";function
...
aN(){aL(g[4],new
d(aC))}d.prototype={string:null,bytes:null,fullBytes:null,array:null,len:null,last:0,toJsString:function(){var
...
d();function
bg(a){if(a<0)F("String.create");return new
aH(a)}function
bk(a,b){var
...
instanceof
Array&&a[0]===(a[0]|0)){var
g=a[0];if(g===S)g=0;if(g===aB){a=a[1];continue}else
if(b
instanceof
Array&&b[0]===(b[0]|0)){var
h=b[0];if(h===S)h=0;if(h===aB){b=b[1];continue}else
if(g!=h)return g<h?-1:1;else
switch(g){case
248:var
e=bl(a[2],b[2]);if(e!=0)return e;break;case
251:F("equal: abstract value");case
B:var
e=bk(a,b);if(e!=0)return e;break;default:if(a.length!=b.length)return a.length<b.length?-1:1;if(a.length>1)f.push(a,b,1)}}else
return 1}else
if(b
instanceof
d||b
...
G(a){a=a
instanceof
d?a.toString():a;if(a.charCodeAt(0)!=47)a=bh+a;var
...
f=a.toString(),i=G(a);if(d.rdonly&&d.wronly)k(f+" : flags Open_rdonly and Open_wronly are not compatible");if(d.text&&d.binary)k(f+" : flags Open_text and Open_binary are not compatible");if(bC(a)){if(bD(a))k(f+" : is a directory");if(d.create&&d.excl)k(f+R);var
h=g.fd_last_idx?g.fd_last_idx:0,e=T(i);if(d.truncate)e.truncate();return y(h+1,e.content(),d)}else
if(d.create){var
h=g.fd_last_idx?g.fd_last_idx:0;bi(a,[]);var
e=T(i);return y(h+1,e.content(),d)}else
aK(a)}y(0,[]);y(1,[]);y(2,[]);function
bq(a){var
...
h=[0,a2.slice(),0],i=V,an=null,ao=[0,a6],a5=i.Array;ax(a7,[0,ao,{}][0+1]);var
...
am=bE(0),ba=20,N=20,ai=0===am.length-1?[0,0]:am,L=ai.length-1,aU=0;if(!0){var
t=aU;for(;;){P(h[1],t,t);var
a0=t+1|0;if(54!==t){var
t=a0;continue}break}}var
M=[0,aV],aW=0,aX=55,aY=bj(55,L)?aX:L,aj=54+aY|0;if(!(aj<0)){var
s=aW;for(;;){var
ak=s%55|0,al=M[1],ah=Z(f(ai,bt(s,L))),J=al.getLen(),Y=ah.getLen(),z=bg(J+Y|0);ay(al,0,z,0,J);ay(ah,0,z,J,Y);M[1]=bo(z,0,z.getLen());var
A=M[1];P(h[1],ak,(f(h[1],ak)^(((A.safeGet(0)+(A.safeGet(1)<<8)|0)+(A.safeGet(2)<<16)|0)+(A.safeGet(3)<<24)|0))&D);var
aZ=s+1|0;if(aj!==s){var
s=aZ;continue}break}}h[2]=0;function
ap(a){var
c=99;if(!(D<99))if(0<c)for(;;){h[2]=(h[2]+1|0)%55|0;var
d=f(h[1],h[2]),b=(f(h[1],(h[2]+24|0)%55|0)+(d^d>>>25&31)|0)&D;P(h[1],h[2],b);var
e=b%c|0;if(((D-c|0)+1|0)<(b-e|0))continue;return e+1|0}throw[0,X,a1]}if(0===N)var
p=[0];else{var
aa=az(N,ap(0)),ab=N-1|0,aP=1;if(!(ab<1)){var
r=aP;for(;;){aa[r+1]=ap(r);var
aQ=r+1|0;if(ab!==r){var
r=aQ;continue}break}}var
p=aa}function
aq(a,b){return[0,b,[0,[S,a*40,aF-b*3],ba,b*3],0]}var
K=p.length-1;if(0===K)var
c=[0];else{var
ac=az(K,aq(0,p[0+1])),ad=K-1|0,aR=1;if(!(ad<1)){var
o=aR;for(;;){ac[o+1]=aq(o,p[o+1]);var
aS=o+1|0;if(ad!==o){var
o=aS;continue}break}}var
c=ac}var
u=i.document.createElement(aD);if(1-(u.getContext==an?1:0)){u[b("width")]=800;u[b("height")]=q;var
e=u.getContext(a8),O=function(a,b){a[1]=b;a[2][1][2]=aF-b*3;a[2][3]=b*3;return 0},ar=function(a,b,c){var
d=f(a,b)[1];O(f(a,b),f(a,c)[1]);return O(f(a,c),d)},m=function(a,b){a[1]=_(a[1],[0,b,0]);return 0},v=function(a,b){var
d=f(a,b),c=d[2],g=d[1],h=d[3];return function(a){e.clearRect(c[1][1],c[1][2],c[2],q);e.fillStyle=h?aG:aA;e.fillRect(c[1][1],c[1][2],c[2],c[3]);e.fillText(g,c[1][1]+3,q);return 0}},as=function(a,b){var
c=f(a,b)[2];return function(a){e.fillStyle="red";e.fillRect(c[1][1],c[1][2],c[2],c[3]);return 0}},at=function(a,b,c){var
h=c?c[1]:1,g=f(a,b),d=g[2],i=g[1];e.clearRect(d[1][1],0,d[2],q);if(h)e.fillStyle="yellow";e.fillRect(d[1][1],d[1][2],d[2],d[3]);return e.fillText(i,d[1][1]+3,q)},au=function(a){if(a){var
c=a[2];(function(a,b){return a.length==1?a(b):x(a,[b])}(a[1],0));i.setTimeout(function(a){return au(c)},C);var
b=0}else
var
b=a;return b},l=[0,0],av=function(a){var
F=a9.getElementById(aD);if(F==an)throw[0,ae,bb];F.appendChild(u);var
x=c.length-1-1|0,G=0;if(!(x<0)){var
r=G;for(;;){var
y=c[r+1],n=y[2],K=y[1];e.fillStyle=aA;e.fillRect(n[1][1],n[1][2],n[2],n[3]);e.fillText(K,n[1][1]+3,q);var
H=r+1|0;if(x!==r){var
r=H;continue}break}}var
A=c.length-1,B=A-1|0,L=0;if(!(B<0)){var
d=L;for(;;){m(l,as(c,d));var
D=d+1|0,E=A-1|0;if(E<D)var
g=d;else{var
b=D,o=d;for(;;){var
j=f(c,b)[2];m(l,function(j,b){return function(a){e.fillStyle="green";e.fillRect(j[1][1],j[1][2],j[2],j[3]);i.setTimeout(v(c,b),C);return 0}}(j,b));if(f(c,b)[1]<f(c,o)[1]){if(o!==d)m(l,v(c,o));m(l,as(c,b));var
w=b}else
var
w=o;var
N=b+1|0;if(E!==b){var
b=N,o=w;continue}var
g=w;break}}if(g!==d){m(l,function(d,g){return function(a){var
e=0,b=0?e[1]:1;ar(c,d,g);at(c,d,[0,b]);at(c,g,[0,b]);if(b){i.setTimeout(v(c,d),C);i.setTimeout(v(c,g),C)}return 0}}(d,g));ar(c,d,g)}else
m(l,v(c,g));var
h=f(c,d)[2];m(l,function(h,d){return function(a){f(c,d)[3]=1;e.fillStyle=aG;e.fillRect(h[1][1],h[1][2],h[2],h[3]);return 0}}(h,d));var
M=d+1|0;if(B!==d){var
d=M;continue}break}}var
z=p.length-1-1|0,I=0;if(!(z<0)){var
k=I;for(;;){O(f(c,k),p[k+1]);var
J=k+1|0;if(z!==k){var
k=J;continue}break}}var
t=0,s=l[1];for(;;){if(s){var
t=t+1|0,s=s[2];continue}i.alert(Z(t).toString());au(l[1]);return a4}};i.onload=bm(function(a){if(a){var
